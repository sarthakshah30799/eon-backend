...
export const AppDataSource = new DataSource({
  ...
  entities: [
    __dirname +
      "/../!(manual-bill-books|chequebooks|transactions|transfers|card-stock|product-settlement|tt-deal|credit-request-fund|vouchers|monthly-locks|day-end-start-process|stock-revaluation|transaction-data-locks)/**/*.entity{.ts,.js}",
  ],
