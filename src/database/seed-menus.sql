...
BEGIN
  ...
  INSERT INTO menus (id, name, path, icon, parent_id, "sortOrder", "isActive", "createdBy", "updatedBy")
  VALUES (gen_random_uuid(), 'Roles Profile', '/master/system-setups/roles-profile', 'shield', v_system_setup_id, 1, true, v_system_user, v_system_user);

  -- Insert "User Profile" under System Setup
  INSERT INTO menus (id, name, path, icon, parent_id, "sortOrder", "isActive", "createdBy", "updatedBy")
  VALUES (gen_random_uuid(), 'User Profile', '/master/system-setups/user-profile', 'users', v_system_setup_id, 2, true, v_system_user, v_system_user);
