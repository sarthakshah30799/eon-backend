...
@Index('IDX_stock_revaluation_items_revaluation_line', ['revaluationId', 'lineNo'], { unique: true })
...
export class StockRevaluationItem extends BaseEntity {
  ...
  @ManyToOne(() => StockRevaluation, (revaluation) => revaluation.items, { onDelete: 'CASCADE' })
  @JoinColumn({ name: 'revaluation_id', foreignKeyConstraintName: 'FK_stock_revaluation_items_revaluation' })
