...
export class CreateCurrencies1780552359592 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_46b8e68b649433979094a8c50e" ON "currencies" ("currency_code") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_8ee6ff98e79c5bc234fba43d61" ON "currencies" ("country_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "currencies" ADD CONSTRAINT "FK_8ee6ff98e79c5bc234fba43d617" FOREIGN KEY ("country_id") REFERENCES "countries"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8ee6ff98e79c5bc234fba43d61"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_46b8e68b649433979094a8c50e"`,
    );
