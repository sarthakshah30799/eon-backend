...
export class AddPartyProfileCardNumberRules1786779972386 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "party_profiles" ADD "card_number_length" integer`);
        await queryRunner.query(`ALTER TABLE "party_profiles" ADD "allow_card_number_masking" boolean NOT NULL DEFAULT false`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "party_profiles" DROP COLUMN "allow_card_number_masking"`);
        await queryRunner.query(`ALTER TABLE "party_profiles" DROP COLUMN "card_number_length"`);
    }
