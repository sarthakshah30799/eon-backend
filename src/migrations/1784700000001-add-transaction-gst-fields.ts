...
export class AddTransactionGstFields1784700000001 implements MigrationInterface {
  name = "AddTransactionGstFields1784700000001";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TYPE "public"."transaction_account_postings_source_type_enum" ADD VALUE IF NOT EXISTS 'GST_ITEM'`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."transaction_account_postings_source_type_enum" ADD VALUE IF NOT EXISTS 'GST_ADDITIONAL_CHARGE'`,
    );

    await queryRunner.query(
      `ALTER TABLE "transactions" ADD COLUMN IF NOT EXISTS "gst_rate_percent" numeric(18,4)`,
    );

    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "transaction_tax_summaries" (
        "transaction_id" uuid NOT NULL,
        "gst_rate_percent" numeric(18,4) NOT NULL DEFAULT 0,
        "taxable_amount" numeric(18,2) NOT NULL DEFAULT 0,
        "item_base_amount" numeric(18,2) NOT NULL DEFAULT 0,
        "item_tax_amount" numeric(18,2) NOT NULL DEFAULT 0,
        "additional_charge_base_amount" numeric(18,2) NOT NULL DEFAULT 0,
        "additional_charge_tax_amount" numeric(18,2) NOT NULL DEFAULT 0,
        ...
        "split_mode" varchar(20) NOT NULL DEFAULT 'CGST_SGST',
        "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
        "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
        CONSTRAINT "PK_transaction_tax_summaries" PRIMARY KEY ("transaction_id"),
        CONSTRAINT "FK_transaction_tax_summaries_transaction_id"
    ...
    await queryRunner.query(`
      ...
      DECLARE
        ...
        v_gst_rate numeric := COALESCE(p_gst_rate_percent, 0);
      ...
      BEGIN
        ...
        IF v_apply_tax THEN
          ...
          v_charge_tax := ROUND(v_charge_base * v_gst_rate / 100, 2);
        END IF;
        ...
        RETURN jsonb_build_object(
          ...
          'gstRatePercent', ROUND(v_gst_rate, 4),
    ...
    await queryRunner.query(`
      ...
      DECLARE
        ...
        v_gst_rate numeric := COALESCE((p_payload->>'gstRatePercent')::numeric, 0);
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        INSERT INTO transaction_tax_summaries (
          ...
          p_transaction_id,
          COALESCE((v_summary->>'gstRatePercent')::numeric, 0),
          ...
          COALESCE(v_summary->>'splitMode', 'CGST_SGST'),
          now(),
          now()
        )
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        IF FOUND THEN
          NEW.gst_rate := ROUND(v_gst_rate, 4);
          NEW.gst_amount := CASE
            WHEN v_apply_tax THEN ROUND(COALESCE(NEW.amount, 0) * v_gst_rate / 100, 4)
            ELSE 0
          END;
        END IF;
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP COLUMN IF EXISTS "gst_rate_percent"`,
    );
  }
}
