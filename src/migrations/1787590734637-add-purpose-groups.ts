...
export class AddPurposeGroups1787590734637 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "purpose_group_purposes" ADD CONSTRAINT "FK_purpose_group_purposes_purpose_group_id" FOREIGN KEY ("purpose_group_id") REFERENCES "purpose_groups"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "purpose_group_purposes" ADD CONSTRAINT "FK_purpose_group_purposes_purpose_id" FOREIGN KEY ("purpose_id") REFERENCES "purposes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "purpose_group_purposes" DROP CONSTRAINT "FK_purpose_group_purposes_purpose_id"`);
        await queryRunner.query(`ALTER TABLE "purpose_group_purposes" DROP CONSTRAINT "FK_purpose_group_purposes_purpose_group_id"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_purpose_group_purposes_purpose_group_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_purpose_group_purposes_purpose_id"`);
