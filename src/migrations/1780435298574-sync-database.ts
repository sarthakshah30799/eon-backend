...
export class SyncDatabase1780435298574 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_5973f79e64a27c506b07cd84b2" ON "branches" ("company_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_00ccc1ed4e9fc23bc124626935" ON "menus" ("parent_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2e67c5fc30b7214f1f8c3d87bc" ON "menus" ("is_active") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "roles_menu_permissions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "role_id" uuid, "company_id" uuid, "menu_id" uuid, "permission_id" uuid, CONSTRAINT "UQ_ec2c487ac6ddb260fc984186be7" UNIQUE ("role_id", "company_id", "menu_id", "permission_id"), CONSTRAINT "PK_05b49b61beaaff9638636cbbfd1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c41f10209aee981df615ba6e71" ON "roles_menu_permissions" ("role_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_83839f8194ed3c648b92ac0ce2" ON "roles_menu_permissions" ("company_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d9437a5e72acbab8b32b45d44d" ON "roles_menu_permissions" ("menu_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f4edaaed7a32498e278a4ac46c" ON "roles_menu_permissions" ("permission_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_roles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid, "role_id" uuid, "branch_id" uuid, "counter_id" uuid, CONSTRAINT "UQ_e64c0d97ac017d9edec15258464" UNIQUE ("user_id", "role_id", "branch_id", "counter_id"), CONSTRAINT "PK_8acd5cf26ebd158416f477de799" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_fe632bf256a18c47bf99d3cf77" ON "user_roles" ("branch_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5fd0d8fb1364c4278327bccdbf" ON "user_roles" ("counter_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."countries_risk_category_enum" AS ENUM('low', 'medium', 'high')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_f3bbd0bc19bb6d8a887add0846" ON "states" ("country_id") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_fd995ee0bec1758b056730f3b8" ON "states" ("country_id", "name") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_ad8e1b9273aa14bb1c42ca4548" ON "states" ("country_id", "code") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "branches" ADD CONSTRAINT "FK_5973f79e64a27c506b07cd84b29" FOREIGN KEY ("company_id") REFERENCES "company"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "menus" ADD CONSTRAINT "FK_00ccc1ed4e9fc23bc1246269359" FOREIGN KEY ("parent_id") REFERENCES "menus"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "roles_menu_permissions" ADD CONSTRAINT "FK_c41f10209aee981df615ba6e716" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "roles_menu_permissions" ADD CONSTRAINT "FK_83839f8194ed3c648b92ac0ce2e" FOREIGN KEY ("company_id") REFERENCES "company"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "roles_menu_permissions" ADD CONSTRAINT "FK_d9437a5e72acbab8b32b45d44d9" FOREIGN KEY ("menu_id") REFERENCES "menus"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "roles_menu_permissions" ADD CONSTRAINT "FK_f4edaaed7a32498e278a4ac46c9" FOREIGN KEY ("permission_id") REFERENCES "permissions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_roles" ADD CONSTRAINT "FK_fe632bf256a18c47bf99d3cf771" FOREIGN KEY ("branch_id") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_roles" ADD CONSTRAINT "FK_5fd0d8fb1364c4278327bccdbf4" FOREIGN KEY ("counter_id") REFERENCES "counters"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_roles" DROP CONSTRAINT "FK_5fd0d8fb1364c4278327bccdbf4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_roles" DROP CONSTRAINT "FK_fe632bf256a18c47bf99d3cf771"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "roles_menu_permissions" DROP CONSTRAINT "FK_f4edaaed7a32498e278a4ac46c9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "roles_menu_permissions" DROP CONSTRAINT "FK_d9437a5e72acbab8b32b45d44d9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "roles_menu_permissions" DROP CONSTRAINT "FK_83839f8194ed3c648b92ac0ce2e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "roles_menu_permissions" DROP CONSTRAINT "FK_c41f10209aee981df615ba6e716"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ad8e1b9273aa14bb1c42ca4548"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fd995ee0bec1758b056730f3b8"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f3bbd0bc19bb6d8a887add0846"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."countries_risk_category_enum"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5fd0d8fb1364c4278327bccdbf"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fe632bf256a18c47bf99d3cf77"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f4edaaed7a32498e278a4ac46c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d9437a5e72acbab8b32b45d44d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_83839f8194ed3c648b92ac0ce2"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c41f10209aee981df615ba6e71"`,
    );
    await queryRunner.query(`DROP TABLE "roles_menu_permissions"`);
    await queryRunner.query(`DROP TABLE "permissions"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2e67c5fc30b7214f1f8c3d87bc"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5973f79e64a27c506b07cd84b2"`,
    );
