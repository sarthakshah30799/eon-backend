...
export class UserRolesExtendsBaseEntity1782153753308 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `UPDATE "user_roles" SET "created_by" = '0f5b1fb3-7a63-43f0-ab36-c4896d6ded09' WHERE "created_by" IS NULL`,
    );
    await queryRunner.query(
      `UPDATE "user_roles" SET "updated_by" = '0f5b1fb3-7a63-43f0-ab36-c4896d6ded09' WHERE "updated_by" IS NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_roles" ALTER COLUMN "created_by" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_roles" ALTER COLUMN "updated_by" SET NOT NULL`,
    );
    await queryRunner.query(
