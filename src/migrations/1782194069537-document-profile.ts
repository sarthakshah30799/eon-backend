...
export class DocumentProfile1782194069537 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4eb74df094c100abccfcc8ae4b"`,
    );
