...
export class CountryBlockMonthlyLock1785061971074 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "unblock_country_access" ADD CONSTRAINT "FK_unblock_country_access_country_id" FOREIGN KEY ("country_id") REFERENCES "countries"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "unblock_country_access" ADD CONSTRAINT "FK_unblock_country_access_branch_id" FOREIGN KEY ("branch_id") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "unblock_country_access" ADD CONSTRAINT "FK_unblock_country_access_user_id" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "countries" ADD CONSTRAINT "FK_countries_blocked_by_id" FOREIGN KEY ("blocked_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "countries" DROP CONSTRAINT "FK_countries_blocked_by_id"`);
        await queryRunner.query(`ALTER TABLE "unblock_country_access" DROP CONSTRAINT "FK_unblock_country_access_user_id"`);
        await queryRunner.query(`ALTER TABLE "unblock_country_access" DROP CONSTRAINT "FK_unblock_country_access_branch_id"`);
        await queryRunner.query(`ALTER TABLE "unblock_country_access" DROP CONSTRAINT "FK_unblock_country_access_country_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "countries" DROP COLUMN "blocked_reason"`);
        await queryRunner.query(`ALTER TABLE "countries" DROP COLUMN "blocked_by_id"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_unblock_country_access_country_branch_user"`);
