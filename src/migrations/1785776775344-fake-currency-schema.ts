...
export class FakeCurrencySchema1785776775344 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "products" ADD "loss_account_id" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_bea649bc7f857121855c4981306" FOREIGN KEY ("loss_account_id") REFERENCES "account_profiles"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "products" DROP CONSTRAINT "FK_bea649bc7f857121855c4981306"`);
        ...
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "loss_account_id"`);
    }
