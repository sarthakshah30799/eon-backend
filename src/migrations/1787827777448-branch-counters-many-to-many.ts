...
export class BranchCountersManyToMany1787827777448 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "branch_counters" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_by" uuid NOT NULL, "updated_by" uuid NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "branch_id" uuid NOT NULL, "counter_id" uuid NOT NULL, CONSTRAINT "UQ_branch_counters_branch_counter" UNIQUE ("branch_id", "counter_id"), CONSTRAINT "PK_da6ff8729e190238031b0bdff5c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_branch_counters_counter_id" ON "branch_counters" ("counter_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_branch_counters_branch_id" ON "branch_counters" ("branch_id") `);
        await queryRunner.query(`ALTER TABLE "branch_counters" ADD CONSTRAINT "FK_f4acf01185eeffb07cfbeacdeb2" FOREIGN KEY ("branch_id") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "branch_counters" ADD CONSTRAINT "FK_62a25d5dc0851aa7fab4477d12f" FOREIGN KEY ("counter_id") REFERENCES "counters"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "branch_counters" DROP CONSTRAINT "FK_62a25d5dc0851aa7fab4477d12f"`);
        await queryRunner.query(`ALTER TABLE "branch_counters" DROP CONSTRAINT "FK_f4acf01185eeffb07cfbeacdeb2"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_branch_counters_branch_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_branch_counters_counter_id"`);
