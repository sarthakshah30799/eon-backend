...
export class TransactionTypeEnumChanges1784969814891 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_purposes_purchase" ON "purposes" ("purchase") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_purposes_sell" ON "purposes" ("sell") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_purposes_individual" ON "purposes" ("individual") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_purposes_corporate" ON "purposes" ("corporate") `,
    );
  }
}
