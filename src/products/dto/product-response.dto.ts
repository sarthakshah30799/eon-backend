...
export class ProductResponseDto {
  ...
  static fromEntity(entity: Product): ProductResponseDto {
    ...
    dto.separateSettlementForEachInstrument =
      entity.separateSettlementForEachInstrument;
    dto.pickSaleRateAvgAsSettlementRate =
      entity.pickSaleRateAvgAsSettlementRate;
    ...
    dto.splitAndStoreBlankStockReceived =
      entity.splitAndStoreBlankStockReceived;
    ...
    dto.allowChangingDenominationInSales =
      entity.allowChangingDenominationInSales;
    ...
    dto.instrumentIssuingAuthorityRequired =
      entity.instrumentIssuingAuthorityRequired;
