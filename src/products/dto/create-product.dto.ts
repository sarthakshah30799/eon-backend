...
export class CreateProductDto {
  ...
  @ApiProperty({
    ...
    example: "General Trading Product",
    maxLength: 250,
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: "Purchase Ret.Canc.A/C",
    required: false,
    maxLength: 100,
  })
  @IsString()
  ...
  @ApiProperty({
    description: "Purchase Blk Canc.A/C",
    required: false,
    maxLength: 100,
  })
  @IsString()
  ...
  @ApiProperty({
    description: "Branch Purchase A/C",
    required: false,
    maxLength: 100,
  })
  @IsString()
  ...
  @ApiProperty({
    description: "Profit A/C Branch Sale",
    required: false,
    maxLength: 100,
  })
  @IsString()
  ...
  // Additional Fields
  @ApiProperty({
    description: "Retail percent/factor",
    required: false,
    maxLength: 50,
  })
  @IsString()
  ...
  @ApiProperty({
    description: "Max Amount Commission",
    required: false,
    maxLength: 50,
  })
  @IsString()
  ...
  @ApiProperty({
    description: "Allow Fraction in FE Amount",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Separate Settlement for Each Instrument",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Pick Sale Rate Avg as Settlement Rate",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Automate Settlement Rate",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Split and Store Blank Stock Received",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Product Requires Settlement",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Pass Auto Receipt of Stock When Sold",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Reversal Effect of Profits",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Allow Changing Denomination in Sales",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Available in Retail Buying",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Series Applicable for Retail Buying",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Available in Retail Selling",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Series Applicable for Retail Selling",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Available in Bulk Buying",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Series Applicable for Bulk Buying",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Available in Bulk Selling",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Series Applicable for Bulk Selling",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Available in Other Transactions (AD1)",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Maintain Blank Stock of Product?",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Denomination Applicable",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Allow Add-On Linking",
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: "Instrument Issuing Authority Required",
    required: false,
    default: false,
  })
  @IsBoolean()
