...
export class CreateExpenseIncomeBookingMasterDto {
  @ApiProperty({
    ...
    example: BookingMasterType.EXPENSE,
  })
  ...
  @ApiPropertyOptional({
    description: "Applicable to customer",
    default: false,
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Applicable to employee",
    default: false,
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Allow receive/payment flag",
    default: false,
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: "Total GST percentage", default: 0.0 })
  @Type(() => Number)
  @IsNumber()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({ description: "TDS value percentage", default: 0.0 })
  @Type(() => Number)
  @IsNumber()
  @IsOptional()
  @Min(0)
