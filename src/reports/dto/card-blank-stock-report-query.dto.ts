...
export class CardBlankStockReportQueryDto {
  @ApiPropertyOptional({
    description: "Receipt start date in YYYY-MM-DD format",
  })
  @IsDateString()
  @IsOptional()
  startDate?: string;
  ...
  @ApiPropertyOptional({
    description: "Receipt end date in YYYY-MM-DD format",
  })
  @IsDateString()
  @IsOptional()
  endDate?: string;
  ...
  @ApiPropertyOptional({
    description: "Filter by current holding branch ids",
    isArray: true,
  })
  ...
  @ApiPropertyOptional({
    description: "Sort order by receipt date",
    enum: ReportSortBy,
