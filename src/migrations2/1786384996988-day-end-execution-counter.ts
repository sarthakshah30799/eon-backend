...
export class DayEndExecutionCounter1786384996988 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "day_end_executions" ADD "counter_id" uuid`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_day_end_executions_branch_user_business_date" ON "day_end_executions" ("branch_id", "business_date", "user_id") `);
    }
