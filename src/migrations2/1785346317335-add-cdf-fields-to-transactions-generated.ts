...
export class AddCdfFieldsToTransactionsGenerated1785346317335 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "cdf_issuing_authority" citext`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "cdf_approved_usd" numeric(18,2)`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "cdf_arrival_date" date`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP COLUMN "cdf_arrival_date"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP COLUMN "cdf_approved_usd"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP COLUMN "cdf_issuing_authority"`,
    );
