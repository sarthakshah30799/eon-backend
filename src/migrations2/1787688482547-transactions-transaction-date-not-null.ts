...
export class TransactionsTransactionDateNotNull1787688482547 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`ALTER TABLE "transactions" ALTER COLUMN "transaction_date" SET NOT NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "transactions" ALTER COLUMN "transaction_date" DROP NOT NULL`);
    }
