...
export class EodBodMonthLock1785062360817 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transactions_transaction_date"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."day_end_executions_status_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_monthly_lock_windows_branch_user"`,
    );
