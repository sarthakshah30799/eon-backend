...
export class AddTransactionFlow1783263858596 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_transaction_items_transaction_line" ON "transaction_items" ("transaction_id", "line_no") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_transaction_documents_transaction_line" ON "transaction_documents" ("transaction_id", "line_no") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_transaction_documents_transaction_id" ON "transaction_documents" ("transaction_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "transaction_additional_charges" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_by" uuid NOT NULL, "updated_by" uuid NOT NULL, "transaction_id" uuid NOT NULL, "line_no" integer NOT NULL, "account_id" uuid NOT NULL, "account_snapshot" jsonb, "amount" numeric(18,4) NOT NULL, "gst_rate" numeric(18,4), "gst_amount" numeric(18,4), "remarks" text, CONSTRAINT "PK_bde531551c5c9de16965cf2c675" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_transaction_additional_charges_transaction_line" ON "transaction_additional_charges" ("transaction_id", "line_no") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_transaction_additional_charges_transaction_id" ON "transaction_additional_charges" ("transaction_id") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."transaction_payments_method_enum" AS ENUM('CASH', 'CHEQUE', 'BANK_TRANSFER', 'UPI', 'NEFT', 'RTGS', 'IMPS', 'CARD', 'OTHER')`,
    );
    await queryRunner.query(
      `CREATE TABLE "transaction_payments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_by" uuid NOT NULL, "updated_by" uuid NOT NULL, "transaction_id" uuid NOT NULL, "line_no" integer NOT NULL, "account_id" uuid NOT NULL, "account_snapshot" jsonb, "cheque_page_id" uuid, "cheque_page_snapshot" jsonb, "payment_method" "public"."transaction_payments_method_enum" NOT NULL DEFAULT 'OTHER', "reference_number" character varying(100), "reference_date" date, "branch_name" character varying(255), "amount" numeric(18,4) NOT NULL, "remarks" text, CONSTRAINT "PK_324e77bea070ff5e6822f478da1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_transaction_payments_transaction_line" ON "transaction_payments" ("transaction_id", "line_no") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_transactions_party_profile_id" ON "transactions" ("party_profile_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_transactions_branch_id" ON "transactions" ("branch_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_transactions_root_transaction_id" ON "transactions" ("root_transaction_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_transactions_number" ON "transactions" ("number") `,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_items" ADD CONSTRAINT "FK_transaction_items_transaction_id" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_documents" ADD CONSTRAINT "FK_transaction_documents_transaction_id" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_additional_charges" ADD CONSTRAINT "FK_transaction_additional_charges_transaction_id" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_payments" ADD CONSTRAINT "FK_transaction_payments_transaction_id" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_logs" ADD CONSTRAINT "FK_transaction_logs_transaction_id" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_events" ADD CONSTRAINT "FK_transaction_events_transaction_id" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD CONSTRAINT "FK_transactions_root_transaction_id" FOREIGN KEY ("root_transaction_id") REFERENCES "transactions"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP CONSTRAINT "FK_transactions_root_transaction_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_events" DROP CONSTRAINT "FK_transaction_events_transaction_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_logs" DROP CONSTRAINT "FK_transaction_logs_transaction_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_payments" DROP CONSTRAINT "FK_transaction_payments_transaction_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_additional_charges" DROP CONSTRAINT "FK_transaction_additional_charges_transaction_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_documents" DROP CONSTRAINT "FK_transaction_documents_transaction_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_items" DROP CONSTRAINT "FK_transaction_items_transaction_id"`,
    );
    await queryRunner.query(`DROP INDEX "public"."IDX_transactions_number"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transactions_root_transaction_id"`,
    );
    await queryRunner.query(`DROP INDEX "public"."IDX_transactions_branch_id"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transactions_party_profile_id"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transaction_events_transaction_id"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transaction_logs_transaction_id"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transaction_payments_transaction_id"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transaction_payments_transaction_line"`,
    );
    await queryRunner.query(`DROP TABLE "transaction_payments"`);
    await queryRunner.query(
      `DROP TYPE "public"."transaction_payments_method_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transaction_additional_charges_transaction_id"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transaction_additional_charges_transaction_line"`,
    );
    await queryRunner.query(`DROP TABLE "transaction_additional_charges"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transaction_documents_transaction_id"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transaction_documents_transaction_line"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_transaction_items_transaction_line"`,
    );
