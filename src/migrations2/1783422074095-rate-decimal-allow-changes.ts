...
export class RateDecimalAllowChanges1783422074095 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "transaction_items" ADD "per" numeric`);
        await queryRunner.query(`ALTER TABLE "transaction_items" ALTER COLUMN "rate" TYPE numeric(18,7)`);
        await queryRunner.query(`ALTER TABLE "transaction_items" ALTER COLUMN "commission" TYPE numeric(18,2)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transaction_items" ALTER COLUMN "commission" TYPE numeric(18,4)`);
        await queryRunner.query(`ALTER TABLE "transaction_items" ALTER COLUMN "rate" TYPE numeric(18,4)`);
        await queryRunner.query(`ALTER TABLE "transaction_items" DROP COLUMN "per"`);
    }
