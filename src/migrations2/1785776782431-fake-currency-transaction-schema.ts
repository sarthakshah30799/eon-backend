...
export class FakeCurrencyTransactionSchema1785776782431 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transactions" ADD "reason_snapshot" jsonb`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."transaction_account_postings_source_type_enum" AS ENUM('ITEM', 'ITEM_PROFIT', 'ITEM_SALE', 'ROUND_OFF', 'PARTY_CONTROL', 'ADDITIONAL_CHARGE', 'TAX_ITEM', 'TAX_ADDITIONAL_CHARGE', 'AGENT_COMMISSION', 'TDS', 'PAYMENT', 'FAKE_CURRENCY')`);
        ...
        await queryRunner.query(`ALTER TABLE "transfer_requests" ALTER COLUMN "bill_reference" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "transactions" ALTER COLUMN "party_profile_id" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "CHK_transactions_party_profile_required" CHECK (UPPER("slug") = 'FAKE_CURRENCY' OR "party_profile_id" IS NOT NULL)`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transactions" ALTER COLUMN "party_profile_id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "transfer_requests" ALTER COLUMN "bill_reference" DROP NOT NULL`);
        await queryRunner.query(`CREATE TYPE "public"."transaction_account_postings_source_type_enum_old" AS ENUM('ITEM', 'ITEM_PROFIT', 'ITEM_SALE', 'ROUND_OFF', 'PARTY_CONTROL', 'ADDITIONAL_CHARGE', 'TAX_ITEM', 'TAX_ADDITIONAL_CHARGE', 'PAYMENT', 'AGENT_COMMISSION', 'TDS')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."manual_books_transaction_type_enum_old" AS ENUM('PURCHASE_FFMC', 'PURCHASE_CORPORATE_INDIVIDUAL', 'SALE_CORPORATE_INDIVIDUAL', 'SALE_FFMC', 'SALE_RMC', 'SALE_FOREX', 'SALE_FOREIGN', 'SALE_MISC', 'SALE_FRANCHISE', 'PURCHASE_RMC', 'PURCHASE_FOREX', 'PURCHASE_FOREIGN', 'PURCHASE_MISC', 'PURCHASE_FRANCHISE')`);
        ...
        await queryRunner.query(`ALTER TABLE "transactions" DROP COLUMN "reason_snapshot"`);
        await queryRunner.query(`ALTER TABLE "transactions" DROP COLUMN "reason_id"`);
