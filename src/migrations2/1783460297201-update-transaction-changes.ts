...
export class UpdateTransactionChanges1783460297201 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "transaction_payments" ADD "drawn_on" character varying(255)`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_manual_books_branch_id" ON "manual_books" ("branch_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_cheque_books_branch_id" ON "cheque_books" ("branch_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_transaction_payments_cheque_page_id" ON "transaction_payments" ("cheque_page_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_transactions_manual_book_page_id" ON "transactions" ("manual_book_page_id") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_transactions_manual_book_page_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_transaction_events_status_available_at"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_transaction_payments_cheque_page_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "transaction_payments" DROP COLUMN "drawn_on"`);
    }
