...
export class AddAgentCommissionTdsPostingSourceTypes1785500097047 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TYPE "public"."transaction_account_postings_source_type_enum" ADD VALUE IF NOT EXISTS 'AGENT_COMMISSION'`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."transaction_account_postings_source_type_enum" ADD VALUE IF NOT EXISTS 'TDS'`,
    );
  }
