...
export class UpdateFinancialSubProfileNestedDto {
  @ApiProperty({
    description: "Financial Sub Profile UUID (if existing)",
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: "Financial Sub Code",
    example: "HDFCA",
    required: false,
  })
  @IsString()
  ...
  @ApiProperty({
    description: "Priority/Sort order",
    example: 1,
    default: 0,
    required: false,
  })
...
export class UpdateFinancialCodeDto {
  ...
  @ApiProperty({
    description: "Unique financial code",
    example: "BANKBL",
    required: false,
  })
  @IsString()
