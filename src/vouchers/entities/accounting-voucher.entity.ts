...
@Index("IDX_accounting_vouchers_idempotency", ["idempotencyKey"], {
  unique: true,
})
@Index("IDX_accounting_vouchers_party_branch_date", [
  "partyProfileId",
  "branchId",
  "transactionDate",
])
...
export class AccountingVoucher extends BaseEntity {
  ...
  @Column({ type: "uuid", name: "account_type_option_id", nullable: true })
  accountTypeOptionId: string | null;
  @Column({ type: "jsonb", name: "account_type_snapshot", nullable: true })
  accountTypeSnapshot: TransactionReferenceSnapshotValue;
  @Column({
    type: "enum",
    enum: VoucherAccountMode,
    name: "account_mode",
    nullable: true,
  })
  accountMode: VoucherAccountMode | null;
  @Column({ type: "uuid", name: "header_account_id", nullable: true })
  headerAccountId: string | null;
  @Column({ type: "jsonb", name: "header_account_snapshot", nullable: true })
  headerAccountSnapshot: TransactionReferenceSnapshotValue;

  @Column({ type: "uuid", name: "entity_type_option_id", nullable: true })
  entityTypeOptionId: string | null;
  @Column({ type: "jsonb", name: "entity_type_snapshot", nullable: true })
  ...
  @Column({ type: "citext", name: "pan_number", nullable: true }) panNumber:
    | string
    | null;
  @Column({ type: "citext", name: "pan_name", nullable: true }) panName:
    | string
    | null;
  ...
  @Column({ type: "date", name: "cheque_date", nullable: true }) chequeDate:
    | string
    | null;
  @Column({ type: "text", name: "cheque_branch", nullable: true })
  chequeBranch: string | null;
  @Column({ type: "text", name: "drawn_on", nullable: true }) drawnOn:
    | string
    | null;
  ...
  remarkSnapshot: TransactionReferenceSnapshotValue;
  ...
  @Column({
    type: "jsonb",
    name: "advance_control_account_snapshot",
    nullable: true,
  })
