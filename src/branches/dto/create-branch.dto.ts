...
export class CreateBranchDto {
  ...
  @Matches(/^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[A-Z0-9]{1}Z[A-Z0-9]{1}$/i, {
    message:
      "GST No. must follow the strict GSTIN format (e.g., 27AAAAA1111A1Z5)",
  })
  gstNo?: string;
  ...
  @ApiProperty({
    description: "Connected counter IDs (UUIDs)",
    type: [String],
    required: false,
  })
