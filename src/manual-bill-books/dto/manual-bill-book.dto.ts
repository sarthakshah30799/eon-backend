...
export class CreateManualBookDto {
  ...
  @IsIn([...Object.values(TransactionTypeProfileEnum), "PURCHASE", "SALE"])
  @IsNotEmpty()
...
export class ApproveRejectManualBookDto {
  @ApiProperty({
    description: "Status",
    enum: WorkflowStatus,
    example: WorkflowStatus.APPROVE,
  })
...
export class AssignPagesDto {
  @ApiProperty({
    description: "List of page assignments",
...
export class TransferPagesDto {
  @ApiProperty({
    description: "List of page numbers to transfer",
    type: [Number],
  })
  @IsArray()
  @IsNumber({}, { each: true })
...
export class UpdatePageStatusDto {
  ...
  @ApiProperty({
    description: "Optional remarks explaining why",
    required: false,
  })
  @IsString()
  @IsOptional()
...
export class ReturnPagesDto {
  @ApiProperty({
    description: "List of page numbers to return",
    type: [Number],
  })
  @IsArray()
  @IsNumber({}, { each: true })
...
export class ManageDeliveryPersonDto {
  @ApiProperty({
    description: "User ID (UUID) to add/remove as delivery person",
  })
  @IsUUID()
  @IsNotEmpty()
  userId: string;
