...
export class CardStockReceiptItem extends BaseEntity {
  ...
  @ManyToOne(() => CardStockReceipt, receipt => receipt.items, { onDelete: 'CASCADE' })
  @JoinColumn({ name: 'receipt_id', foreignKeyConstraintName: 'FK_card_stock_receipt_items_receipt' })
