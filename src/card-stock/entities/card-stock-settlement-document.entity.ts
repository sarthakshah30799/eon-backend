...
@Index('IDX_card_stock_settlement_documents_number', ['transactionNumber'], { unique: true })
...
export class CardStockSettlementDocument extends BaseEntity {
  ...
  @JoinColumn({ name: 'posting_transaction_id', foreignKeyConstraintName: 'FK_card_stock_settlement_documents_posting' })
