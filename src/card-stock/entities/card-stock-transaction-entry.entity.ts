...
export class CardStockTransactionEntry extends BaseEntity {
  ...
  @ManyToOne(() => CardStockCard, card => card.transactionEntries, { onDelete: 'RESTRICT' })
  @JoinColumn({ name: 'card_id', foreignKeyConstraintName: 'FK_card_stock_entries_card' })
  card: CardStockCard;
  ...
  @Column({ type: 'enum', enum: CardStockOperationType, name: 'operation_type' })
