...
@Module({
  imports: [AdditionalSettingModule, DayEndStartProcessModule, TypeOrmModule.forFeature([Branch, Currency, PartyProfile, Product, ProductCardIssuer]), TypeOrmModule.forFeature([CardStockReceipt, CardStockReceiptItem, CardStockCard], 'database2')],
